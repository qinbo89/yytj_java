package com.hongbao.dal.mybatis;
...
public final class IdTypeHandler extends BaseTypeHandler<String> {
	...
	public static void main(String[] args) {
		System.out.println(decode("27"));
		System.out.println(encode(27));
		System.out.println(MD5Util.MD5Encode("4916ADA0-DF7D-4DE6-841F-0CECA7BCCE24"+"5C82AC30-48A4-4391-B805-3D521C1C269B"));
