...
import com.alipay.config.AlipayBarPayConfig;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        String mysign = "";
        if(AlipayBarPayConfig.sign_type.equals("MD5") ) {
        	mysign = MD5.sign(prestr, AlipayBarPayConfig.key, AlipayBarPayConfig.input_charset);
        }
        return mysign;
    }
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        ...
        sPara.put("sign_type", AlipayBarPayConfig.sign_type);
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
                      + "_input_charset=" + AlipayBarPayConfig.input_charset + "\" method=\"" + strMethod
                      + "\">");
    ...
    public static String buildRequest(String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
        ...
        //设置编码集
        request.setCharset(AlipayBarPayConfig.input_charset);

        request.setParameters(generatNameValuePair(sPara));
        request.setUrl(ALIPAY_GATEWAY_NEW+"_input_charset="+AlipayBarPayConfig.input_charset);
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + AlipayBarPayConfig.partner + "&_input_charset" +AlipayBarPayConfig.input_charset;
