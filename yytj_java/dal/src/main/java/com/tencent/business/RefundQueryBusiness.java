...
public class RefundQueryBusiness {
    ...
    public RefundQueryBusiness(WeiXinConfigure weiXinConfigure) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        refundQueryService = new RefundQueryService(weiXinConfigure);
    ...
    public void run(RefundQueryReqData refundQueryReqData,RefundQueryBusiness.ResultListener resultListener) throws Exception {
        ...
        ReportReqData reportReqData = new ReportReqData(
                ...
                WeiXinConfigure.REFUND_QUERY_API,
        ...
        if (refundQueryResData.getReturn_code().equals("FAIL")) {
            ...
            if (!Signature.checkIsSignValidFromResponseString(weiXinConfigure,refundQueryServiceResponseString)) {
