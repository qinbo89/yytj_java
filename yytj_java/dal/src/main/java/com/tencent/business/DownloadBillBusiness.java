...
public class DownloadBillBusiness {
    ...
    public DownloadBillBusiness(WeiXinConfigure weiXinConfigure) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        downloadBillService = new DownloadBillService(weiXinConfigure);
    ...
    public void run(DownloadBillReqData downloadBillReqData,ResultListener resultListener) throws Exception {
        ...
        try {
            ...
            ReportReqData reportReqData = new ReportReqData(
                    ...
                    WeiXinConfigure.DOWNLOAD_BILL_API,
