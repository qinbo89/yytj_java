...
public class RefundBusiness {
    ...
    public RefundBusiness(WeiXinConfigure weiXinConfigure) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        refundService = new RefundService(weiXinConfigure);
    ...
    public void run(RefundReqData refundReqData,ResultListener resultListener) throws Exception {
        ...
        if (refundResData.getReturn_code().equals("FAIL")) {
            ...
            if (!Signature.checkIsSignValidFromResponseString(weiXinConfigure,refundServiceResponseString)) {
