...
public class ScanPayReqData {
     ...
     */
    public ScanPayReqData(WeiXinConfigure weiXinConfigure,String authCode,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag){
        
        if(NumberUtils.isDigits(authCode)==false){
            throw new BizException("请扫描微信支付二维码");
        }
        
        setSdk_version(weiXinConfigure.getSdkVersion());

        //微信分配的公众号ID（开通公众号之后可以获取到）
        setAppid(weiXinConfigure.getAppid());

        //微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
        setMch_id(weiXinConfigure.getMchid());
