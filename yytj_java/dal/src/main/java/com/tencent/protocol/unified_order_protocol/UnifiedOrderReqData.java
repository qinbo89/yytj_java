...
public class UnifiedOrderReqData {
     ...
     */
    public UnifiedOrderReqData(WeiXinConfigure weiXinConfigure,String body,String outTradeNo,int totalFee,String spBillCreateIP){
        ...
        if(CustomizedPropertyConfigurer.isProd()){
            setNotify_url("http://user.api.yuntaohongbao.com/weiXinNotify/"+outTradeNo+"/"+weiXinConfigure.getAppType());
        }else{
            setNotify_url("http://test.user.api.yuntaohongbao.com/weiXinNotify/"+outTradeNo+"/"+weiXinConfigure.getAppType());
        }
