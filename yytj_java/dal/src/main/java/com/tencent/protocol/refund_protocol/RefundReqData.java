...
public class RefundReqData {
     ...
     */
    public RefundReqData(WeiXinConfigure weiXinConfigure,String transactionID,String outTradeNo,String deviceInfo,String outRefundNo,int totalFee,int refundFee,String opUserID,String refundFeeType){
        ...
        setTotal_fee(Math.abs(totalFee));

        setRefund_fee(Math.abs(refundFee));
