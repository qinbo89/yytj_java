...
public class HttpsRequest implements IServiceRequest{
    ...
    public HttpsRequest(WeiXinConfigure weiXinConfigure) throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
    ...
    private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
       ...
       // ClassPathResource r = new ClassPathResource(Configure.getCertLocalPath(),Configure.class);
        InputStream instream = null;// r.getInputStream();//new FileInputStream(new File(Configure.getCertLocalPath()));//加载本地的证书进行https加密传输
        instream =  this.getClass().getResourceAsStream(weiXinConfigure.getCertLocalPath());
        try {
            keyStore.load(instream, weiXinConfigure.getCertPassword().toCharArray());//设置证书密码
