...
public class ReportReqData {
     ...
     */
    public ReportReqData(WeiXinConfigure weiXinConfigure,String deviceInfo, String interfaceUrl,int executeTimeCost, String returnCode,String returnMsg,String resultCode,String errCode,String errCodeDes, String outTradeNo,String userIp){
        ...
        setSub_mch_id(weiXinConfigure.getSubMchid());
