 ...
 */
public class WeiXinBizConfigure implements WeiXinConfigure {

    private static final String appType = "biz";
    // sdk的版本号
    ...
    private static String key = "b62dd1d83d9c4884820d5f2e2fe70bb0";

    // 微信分配的公众号ID（开通公众号之后可以获取到）
    private static String appID = "wx13769fcba4f54d14";

    // 微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
    private static String mchID = "1249368801";

    // 受理模式下给子商户分配的子商户号
    private static String subMchID = "";

    // HTTPS证书的本地路径
    private static String certLocalPath = "/com/tencent/common/biz/cert/apiclient_cert.p12";

    // HTTPS证书密码，默认密码等于商户号MCHID
    private static String certPassword = "1249368801";
