 ...
 */
public class WeiXinKWConfigure implements WeiXinConfigure {
    private static final String appType = "kw";
    // sdk的版本号
    ...
    // HTTPS证书的本地路径
    private static String certLocalPath = "/com/tencent/common/kw/cert/apiclient_cert.p12";

    // HTTPS证书密码，默认密码等于商户号MCHID
    private static String certPassword = "1241085502";
