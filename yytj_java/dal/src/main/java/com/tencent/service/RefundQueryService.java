...
public class RefundQueryService extends BaseService{
    ...
    public RefundQueryService(WeiXinConfigure weiXinConfigure) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        super(weiXinConfigure,WeiXinConfigure.REFUND_QUERY_API);
    }
