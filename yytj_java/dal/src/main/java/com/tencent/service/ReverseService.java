...
public class ReverseService extends BaseService{
    ...
    public ReverseService(WeiXinConfigure weiXinConfigure) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        super(weiXinConfigure,WeiXinConfigure.REVERSE_API);
    }
