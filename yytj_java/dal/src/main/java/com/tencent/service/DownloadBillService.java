...
public class DownloadBillService extends BaseService{
    ...
    public DownloadBillService(WeiXinConfigure weiXinConfigure) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        super(weiXinConfigure,WeiXinConfigure.DOWNLOAD_BILL_API);
    }
