...
public class ScanPayQueryService extends BaseService{
    ...
    public ScanPayQueryService(WeiXinConfigure weiXinConfigure) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        super(weiXinConfigure,WeiXinConfigure.PAY_QUERY_API);
    }
