...
public class RefundService extends BaseService{
    ...
    public RefundService(WeiXinConfigure weiXinConfigure) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        super(weiXinConfigure,WeiXinConfigure.REFUND_API);
    }
