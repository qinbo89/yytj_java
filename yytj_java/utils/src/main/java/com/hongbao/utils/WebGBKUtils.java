 ...
 */
public abstract class WebGBKUtils {
    ...
    public static void main(String[] args) throws IOException {
        //System.out.println(WebUtils.doGet("http://www.baidu.com", new HashMap<String, String>()));
        //System.out.println(WebUtils.doPost("http://www.baidu.com", new HashMap<String, String>(),10000,10000));
    }
    ...
    public static String doPost(String url, Map<String, String> params) throws IOException {
        return doPost(url, params, DEFAULT_CHARSET, 10000, 10000);
    }
