...
public class ModelGen {
    ...
    public static void main(String[] args) {
        try {
            List<String> list = FileUtils.readLines(new File("d:/test.txt"), "utf-8");
//            genBean(list);
//            genResultXml(list);
            columnGen(list);
        } catch (IOException e) {
    ...
    static void columnGen(List<String> list) throws IOException {
        ...
        for (String str : list) {
            ...
            if (!str.equals("id")) {
                String propVal = "#{"+str+"}";
                if(str.equals("createdAt") || str.equals("updatedAt")){
                    propVal = "now(6)";
            ...
            //update
            if (!str.equals("id") && !str.equals("createdAt") && !str.equals("delStatus")) {
                String propVal = "#{"+str+"}";
