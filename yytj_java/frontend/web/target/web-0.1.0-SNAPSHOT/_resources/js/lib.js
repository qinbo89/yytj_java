  var $loading = $(['<div id="loading" class="loading" style="background: black;opacity: 0.4;"><div class="inner">',
            '<div class="panel">',
                '<div class="tick-tock">',
...
window.YTLib = {
        ...
        popMessage: function (msg, duration, bgColor,options) {
        	var self = this;
        	options = options || {} ;
        	if(options.confirm){
        		self.confirm({message:msg,cancel:false});
        		//layer.alert(msg);
        		return;
        	}
           ...
           $.ajax(jQuery.extend(parma, {
                ...
                success: function (res,textStatus, jqXHR) {
                    ...
                    if (res.success) {
                        ...
                        // 提示自动隐藏后
                        setTimeout(function () {
                        	 self.popMessage(res.message,null,null,{confirm:true});
